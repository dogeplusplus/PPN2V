...
parser.add_argument("--dataPath", help="The path to your image")
parser.add_argument("--fileName", help="name of your image file", default="*.tif")
parser.add_argument("--output", help="The path to which your image is to be saved", default='.')
...
parser.add_argument("--histogram", help="name of .npy-file containing the noise model histogram", default='noise_model.npy')
